#![no_std]
#![no_main]
// ボタン操作の設定が良くわからなかったので、wio-terminalクレートの作例をコピペして、勉強する
// https://github.com/atsamd-rs/atsamd/blob/0820f0df58eb8705ddfa6533ed76953d18e6b992/boards/wio_terminal/examples/buttons.rs
// ボタンから指を放しても、マーカーが消えない
...
fn main() -> ! {
    ...
    let (mut display, _backlight) = sets
        ...
        .init(
            ...
            peripherals.SERCOM7,
            &mut peripherals.MCLK,
            58_u32.mhz(), // 元のプログラムではMHzになっていたがエラーになった
            &mut delay,
        )
        .unwrap();
